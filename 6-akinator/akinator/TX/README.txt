...
Скачать библиотеку: http://sourceforge.net/project/platformdownload.php?group_id=213688.
См. также раздел "Установка библиотеки" в документации TX Library.

Короткая ссылка на онлайн-документацию: http://gg.gg/TXLib.
...
Искусство программирования -- это искусство мышления, не надо это забывать, уважаемые школьники, студенты
и особенно преподаватели.
...
- Среды программирования и исполнения + компиляторы
  ...
  -                     MinGW  GCC 11.2  (NUWEN), 64-bit
  -                     MinGW  GCC 10.3  (TDM),   32-bit и 64-bit
  ...
  - LLVM              + MSVC Clang-cl 11.0,  32-bit и 64-bit
  - LLVM              + MSVC Clang-cl 10.0,  32-bit и 64-bit
  - LLVM              + MSVC Clang-cl 9.0.0, 32-bit и 64-bit
  - Microsoft Visual Studio 17 (2022), 32-bit и 64-bit
